...
#    Updated: 2024/04/01 19:03:02 by pehenri2         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS_PATH			= 	./src/
FILES				= 	$(addprefix $(SRCS_PATH), main.c lexer.c lexer_utils.c parser.c parser_utils.c bin_tree.c bin_tree_utils.c executor.c executor_utils.c token_list.c error.c debug.c)
OBJS				= 	$(FILES:%.c=%.o)
